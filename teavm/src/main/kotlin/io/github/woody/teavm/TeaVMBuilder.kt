...
object TeaVMBuilder {
    ...
    @JvmStatic fun main(arguments: Array<String>) {
        val teaBuildConfiguration = TeaBuildConfiguration().apply {
            ...
            // additionalAssetsClasspathFiles += "io/github/woody/asset.extension"
        }

        // Register any classes or packages that require reflection here:
        // TeaReflectionSupplier.addReflectionClass("io.github.woody.reflect")
...
//        tool.targetType = TeaVMTargetType.WEBASSEMBLY_GC
        ...
        tool.mainClass = "io.github.woody.teavm.TeaVMLauncher"
